...
void read_file(char* file){//opening a text file and putting the values into linked lists
	int groupsize;
	char name[LENGTH];
...
void save_file(char*file){//saving the memory from the linked lists into a text file
	int i;
